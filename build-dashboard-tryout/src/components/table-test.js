...
function TableTest(props){
  ...
  return(
    <section className={active_style.section} id="table">
    <h1 className={active_style.title}> Table </h1>
    <hr />
    <table className={active_style.table}>
      ...
      <tbody>
        ...
        <tr>
          <th> 3 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/Tottenham_Hotspur_F.C." title="Tottenham Hotspur F.C."> Tottenham
              Hotspur </a>
          </td>
          <td> 38 </td>
          <td> 19 </td>
        ...
        <tr>
          <th> 4 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/Manchester_City_F.C." title="Manchester City F.C."> Manchester City
            </a>
          </td>
          <td> 38 </td>
          <td> 19 </td>
        ...
        <tr className={active_style.isSelected}>
          <th> 5 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/Manchester_United_F.C." title="Manchester United F.C."> Manchester
              United </a>
          </td>
          <td> 38 </td>
          <td> 19 </td>
        ...
        <tr>
          <th> 7 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/West_Ham_United_F.C." title="West Ham United F.C."> West Ham United
            </a>
          </td>
          <td> 38 </td>
          <td> 16 </td>
        ...
        <tr>
          <th> 14 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/West_Bromwich_Albion_F.C." title="West Bromwich Albion F.C."> West
              Bromwich Albion </a>
          </td>
          <td> 38 </td>
          <td> 10 </td>
        ...
        <tr>
          <th> 18 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/Newcastle_United_F.C." title="Newcastle United F.C."> Newcastle
              United </a> <strong> (R) </strong> </td>
          <td> 38 </td>
          <td> 9 </td>
          <td> 10 </td>
          <td> 19 </td>
        ...
        <tr>
          <th> 20 </th>
          <td>
            <a href="https://en.wikipedia.org/wiki/Aston_Villa_F.C." title="Aston Villa F.C."> Aston Villa </a> <strong>
              (R) </strong> </td>
          <td> 38 </td>
          <td> 3 </td>
          <td> 8 </td>
    ...
    <br />
    <table className={combineStyles([active_style.table, active_style.isStriped])}>
      <thead>
        <tr>
          <th> One </th>
          <th> Two </th>
    ...
    <br />
    <table className={combineStyles([active_style.table, active_style.isBordered])}>
      <thead>
        <tr>
          <th> One </th>
          <th> Two </th>
    ...
    <br />
    <table className={combineStyles([active_style.table, active_style.isNarrow])}>
      <thead>
        <tr>
          <th> One </th>
          <th> Two </th>
    ...
    <br />
    <table className={combineStyles([active_style.table, active_style.isBordered, active_style.isStriped, active_style.isNarrow])}>
      <thead>
        <tr>
          <th> One </th>
          <th> Two </th>
